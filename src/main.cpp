...
const string strMessageMagic = "BilluCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 100 * 24 * 60 * 60; // BilluCoin: 100 days
static const int64 nTargetSpacing = 12; // BilluCoin: 12 seconds blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal billucoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BilluCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8b0a6bb1aba6cd27faad950bc746e2e10f6d8262951b5b20d8b6be995adc5f0b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Sensex falls 1.25% as Donald Trump poll gains spook markets";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478111440; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1478111440;
            block.nNonce   = 1140228;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x34f3f1f91d5b32e159872881e635318bdc84dcf48854b47abdc0d363e655b34d"));
